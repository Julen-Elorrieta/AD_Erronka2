...
public class GetAllUsers {
    ...
    private ErabiltzaileData jsonToErabiltzaileData(JsonObject userJson) {
        ...
        return new ErabiltzaileData(id, email, erabiltzaileIzena, izena, abizenak, dni, motaId, 
                           telefonoa1, argazkiaUrl, helbidea, telefonoa2);
    }
    ...
    public static class ErabiltzaileData {
        ...
        public ErabiltzaileData(Long id, String email, String erabiltzaileIzena, String izena, 
                       String abizenak, String dni, Integer motaId, 
                       String telefonoa1, String argazkiaUrl, String helbidea, String telefonoa2) {
            this.id = id;
            this.email = email;
        ...
        public Integer getMotaId() { return motaId; }
        public String getTelefonoa1() { return telefonoa1; }
        public String getArgazkiaUrl() { return argazkiaUrl; }
        public String getHelbidea() { return helbidea; }
        public String getTelefonoa2() { return telefonoa2; }
