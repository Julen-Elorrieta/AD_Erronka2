 ...
 * 
 * Conecta con el servidor TCP para obtener y actualizar
...
public class Profile {
    ...
    private UserProfileData jsonToUserProfileData(JsonObject userJson) {
        ...
        return new UserProfileData(id, email, username, nombre, apellidos, dni, 
                                   direccion, telefono1, telefono2, tipoId, argazkiaUrl);
    }
    ...
    public static class UserProfileData {
        ...
        public UserProfileData(Long id, String email, String username, String nombre, 
                              String apellidos, String dni, String direccion,
                              String telefono1, String telefono2, Integer tipoId, 
                              String argazkiaUrl) {
            this.id = id;
            this.email = email;
